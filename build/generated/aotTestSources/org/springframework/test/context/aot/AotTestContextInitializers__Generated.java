...
import com.example.backend.GeneticAlgorithmDockerApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.example.GeneticAlgorithmDocker.GeneticAlgorithmDockerApplicationTests", () -> new GeneticAlgorithmDockerApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.example.GeneticAlgorithmDocker.GeneticAlgorithmDockerApplicationTests", GeneticAlgorithmDockerApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
